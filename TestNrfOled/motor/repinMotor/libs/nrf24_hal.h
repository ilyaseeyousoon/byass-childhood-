...
#define nRF24_CE_L()               HAL_GPIO_WritePin(GPIOA, GPIO_PIN_7, GPIO_PIN_RESET)
#define nRF24_CE_H()               HAL_GPIO_WritePin(GPIOA, GPIO_PIN_7, GPIO_PIN_SET)

// CSN (chip select negative) pin (PA4)
#define nRF24_CSN_PORT             GPIOB
#define nRF24_CSN_PIN              GPIO_PIN_12
#define nRF24_CSN_L()              HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12, GPIO_PIN_RESET)
#define nRF24_CSN_H()              HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12, GPIO_PIN_SET)
