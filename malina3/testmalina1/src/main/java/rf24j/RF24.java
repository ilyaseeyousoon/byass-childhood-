...
public class RF24 {
    ...
    private int payloadSize = 6;
    private final int MAX_PAYLOAD_SIZE		= 6;
...
//        handle = pigpio.spiOpen(JPigpio.PI_SPI_CHANNEL0, JPigpio.PI_SPI_BAUD_8MHZ, 0);
//
...
//    } // End of init
    ...
    public synchronized boolean init(int cePin, int csnPin,int SPI_ch) throws PigpioException {
        this.cePin = cePin;
        this.csnPin = csnPin;
        ...
        handle = pigpio.spiOpen(JPigpio.PI_SPI_CHANNEL0, JPigpio.PI_SPI_BAUD_8MHZ, 0);
         ...
         handle = pigpio.spiOpen(JPigpio.PI_SPI_CHANNEL1, JPigpio.PI_SPI_BAUD_8MHZ, 0);
    ...
    public synchronized void startListening() throws PigpioException {
        ...
        pigpio.gpioDelay(0,JPigpio.PI_MILLISECONDS); // 1.5ms to start
        ...
        pigpio.gpioDelay(0, JPigpio.PI_MICROSECONDS);
    }
    ...
    private void nrfSpiWrite(int reg, byte data[]) throws PigpioException {
        ...
        pigpio.gpioDelay(0,JPigpio.PI_MILLISECONDS);
