...
#define nRF24_CE_L()               digitalWrite(2, 0)
#define nRF24_CE_H()               digitalWrite(2, 1)

// CSN (chip select negative) pin (PA4)
#define nRF24_CSN_L()              digitalWrite(3, 0)
#define nRF24_CSN_H()              digitalWrite(3, 1)
...
static constexpr uint8_t nRF24_RX_PW_PIPE[6] = {
		nRF24_REG_RX_PW_P0,
		nRF24_REG_RX_PW_P1,
		nRF24_REG_RX_PW_P2,
		nRF24_REG_RX_PW_P3,
...
static constexpr uint8_t nRF24_ADDR_REGS[7] = {
...
uint8_t nRF24_GetIRQFlags();
uint8_t nRF24_GetStatus_RXFIFO();
uint8_t nRF24_GetStatus_TXFIFO();
uint8_t nRF24_GetRXSource();
uint8_t nRF24_GetRetransmitCounters();

void nRF24_ResetPLOS();
void nRF24_FlushTX();
void nRF24_FlushRX();
