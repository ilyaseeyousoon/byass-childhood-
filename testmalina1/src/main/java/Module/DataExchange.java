...
public class DataExchange  {
    ...
    int cePin25 = 27;  //GPIO number, e.g. GPIO 22 = PIN 15
    int csnPin25 = 22;  //GPIO number, e.g. GPIO 8 = PIN 24
    ...
    private void Receiver() throws PigpioException {
